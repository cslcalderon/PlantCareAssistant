...
class AdaptiveScheduler:
    """Makes a schedule that is able to adapt to the needs of the plants chosen, the 
    tasks that the """
    ...
    #     """Schedules tasks for known plants ei. plants in plants_dict and with a similar plant"""
